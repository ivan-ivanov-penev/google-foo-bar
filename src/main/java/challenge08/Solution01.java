...
//				System.out.print(crawlers.get(j).currentPosition + " ");
...
//
//			System.out.println(Arrays.toString(helperArr[i]));
//		}
	}
...
//		System.out.println("length: " + helperArr.length);
//		System.out.println("helperArr[0].length: " + helperArr[0].length);
