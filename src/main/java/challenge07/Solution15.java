...
public class Solution15 {
	...
	public static int solution(int[] dimensions, int[] your_position, int[] trainer_position, int distance) {
		...
		return solution2(dimensions, your_position, trainer_position, distance).size();
	}

	public static Set<Pair> solution2(int[] dimensions, int[] your_position, int[] trainer_position, int distance) {

		List<Integer> listX = findHitSpots(distance, trainer_position[0], your_position[0], dimensions[0]);
		List<Integer> listY = findHitSpots(distance, trainer_position[1], your_position[1], dimensions[1]);
	...
	static List<Integer> findHitSpots(int distance, int trainerPosition, int yourPosition, int roomSize) {
